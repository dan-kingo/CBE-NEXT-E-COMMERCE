      ...
      <div class="space-y-4">
        ...
        <div v-else>
          <div class="space-y-3 md:hidden">
            ...
            >
              <div>
                ...
                >
                  ...
                  >
                    ...
                    <Icon
                      :name="
                        row.isExpanded ? 'lucide:folder-open' : 'lucide:folder'
                      "
                      class="size-4 text-muted-foreground"
                    />
                    {{ row.category.name }}
              ...
              <div class="flex justify-end">
                <div class="relative" data-action-menu>
                  ...
                  <div
                    v-if="openActionMenuForId === row.category.id"
            ...
            <p
              v-if="!visibleCategoryRows.length"
          ...
          <div class="mt-4 flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
              <Button
                ...
                variant="outline"
                :disabled="
                  !categoriesPagination.hasPrevious || isCategoriesLoading
                "
