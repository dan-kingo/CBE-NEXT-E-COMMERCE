            ...
            <aside
                ...
                <div class="space-y-10">
                    ...
                    <div class="space-y-4">
                        ...
                        <h1 class="max-w-sm text-3xl font-bold leading-tight text-gray-200 sm:text-4xl">
                            Operations
                        </h1>
                ...
                <p class="hidden text-xs tracking-[0.2em] text-golden/70 md:block">
                    Tenant -> Stores -> Products -> Customer -> Orders
                </p>
            </aside>
            ...
            <div class="flex items-center justify-center px-5 py-10 sm:px-8 lg:px-12">
                <Card
                    ...
                    <CardHeader class="space-y-2">
                        <CardTitle class="pt-6 text-2xl font-bold uppercase tracking-widest text-gray-200">
                            Admin Login
                        </CardTitle>
                        <CardDescription class="text-gray-200">Sign in to your account.</CardDescription>
                    </CardHeader>
                    ...
                    <CardContent>
                        <form class="space-y-6" @submit.prevent="onSubmit">
                            ...
                            <Button v-if="!isLoading"
                                class="h-12 w-full cursor-pointer bg-brand text-white uppercase transition hover:bg-brand/90"
                                type="submit">
                                Sign In
                            </Button>
