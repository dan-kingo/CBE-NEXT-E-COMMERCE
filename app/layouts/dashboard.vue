...
const formatBreadcrumbFromPath = (to: string) => {
    ...
    const label = withoutDashboardPrefix
        .replace(/[-_]/g, ' ')
        .trim()
        ...
        <SidebarInset class="min-h-screen bg-gray-100 font-brand">
            <header
                ...
                <div class="flex min-w-0 items-center gap-3">
                    ...
                    <div class="hidden sm:flex min-w-0 items-center gap-2 whitespace-nowrap">
                ...
                <div ref="profileMenuRef" class="relative">
                    <Button variant="ghost" class="h-10 rounded-full px-2 pr-3 cursor-pointer"
                    ...
                    <div v-if="isProfileMenuOpen"
                        ...
                        <div class="mb-3 border-b pb-3">
                            <p class="text-sm font-semibold text-foreground">{{ adminName }}</p>
